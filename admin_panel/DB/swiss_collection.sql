...
INSERT INTO `orders` (`order_id`, `user_id`, `delivered_to`, `phone_no`, `pay_method`, `pay_status`, `order_status`, `order_date`) VALUES
...
INSERT INTO `product` (`event_id`, `event_name`, `event_desc`, `event_image`, `price`, `category_id`, `uploaded_date`) VALUES
(1, 'Navratri 2022', 'Enjoy navratri 2022 with the best singers', home.', './uploads/nav.jpg', 500, 1, '2022-03-28'),
